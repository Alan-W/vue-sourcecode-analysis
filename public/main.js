...
(function (factory) {
  ...
  UA && /chrome\/\d+/.test(UA) && !isEdge; // Firefox has a "watch" function on Object.prototype...
  ...
  function updateComponentListeners(vm, listeners, oldListeners) {
    target$1 = vm;
    updateListeners(listeners, oldListeners || {}, add$1, remove$1);
  }
  ...
  function mountComponent(vm, el, hydrating) {
    ...
    console.log("trigger _watcher update api : ", vm._watcher);
    debugger;
  ...
  var Watcher = function Watcher(vm, expOrFn, cb, options) {
    ...
    console.log('cb in watcher is: -', cb); // parse expression for getter
  ...
  Watcher.prototype.addDep = function addDep(dep) {
    var id = dep.id;
    console.log('dep in watcher addDep is: -', dep);
  ...
  Watcher.prototype.update = function update() {
    ...
    if (this.lazy) {
      ...
      console.log('sync update in watcher');
      this.run();
    } else {
      queueWatcher(this);
      console.log('update in watcher queneWatcher');
    }
  };
  /**
  ...
  Watcher.prototype.run = function run() {
    if (this.active) {
      var value = this.get();
      console.log('run in watcher value is: -', value);
      ...
      isObject(value) || this.deep) {
        ...
        this.value = value;
        console.log('run in watcher this.cb is: -', this.cb);
  ...
  function initData(vm) {
    ...
    var vmDataObserveInstace = observe(data, true
    /* asRootData */
    );
    console.log('after invoke initData:');
    console.log('1: the vm data is instanceof Observer', vmDataObserveInstace);
    console.log('1: the vm data is instanceof Observer', vmDataObserveInstace instanceof Observer);
  ...
  function model$2(el, dir, _warn) {
    ...
    if (el.component) {
      ...
      return false;
    } else ; // ensure runtime directive metadata
  ...
  function preTransformNode(el, options) {
    if (el.tag === 'input') {
      ...
      if (map['v-model'] && (map['v-bind:type'] || map[':type'])) {
        ...
        var ifConditionExtra = ifCondition ? "&&(" + ifCondition + ")" : ""; // 1. checkbox
  ...
  new RegExp('\\b' + ('do,if,for,let,new,try,var,case,else,with,await,break,catch,class,const,' + 'super,throw,while,yield,delete,export,import,return,switch,default,' + 'extends,finally,continue,debugger,function,arguments').split(',').join('\\b|\\b') + '\\b'); // these unary operators should not be used as property/method names

  new RegExp('\\b' + 'delete,typeof,void'.split(',').join('\\s*\\([^\\)]*\\)|\\b') + '\\s*\\([^\\)]*\\)'); // check valid identifier for v-for
  ...
  var child1 = {
  render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('section',{staticClass:"child1"},[_c('p',[_vm._v("child1: "+_vm._s(_vm.key))]),_vm._v(" "),_c('p',[_vm._v("props from parent: "+_vm._s(_vm.raw))])])},
  staticRenderFns: [],
    name: 'child1',
    props: ['raw'],
    data: function data() {
